...
public class FieldCopyUtil_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.landlord.utils.FieldCopyUtil"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(FieldCopyUtil_ESTest_scaffolding.class.getClassLoader() ,
      "com.landlord.utils.FieldCopyUtil"
    );
  } 

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(FieldCopyUtil_ESTest_scaffolding.class.getClassLoader()); 
